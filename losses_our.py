...
#        print('gt_sequence_valid', gt_sequence_valid.shape)
        gt_sequence = tf.cast(gt_sequence, tf.int32)
#        print('gt_sequence', gt_sequence.shape)
        if self.channel_axis == 2:
            output_sequence = tf.transpose(output_sequence, (0, 1, 3, 4, 2))

        onehot_gt = tf.one_hot(tf.cast(gt_sequence, tf.int32), 2)
...
#        print('gt_sequence', gt_sequence.shape)
#        print('output_sequence', output_sequence.shape)
