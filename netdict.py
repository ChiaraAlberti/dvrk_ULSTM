...
def Net_type(dropout, reg, kernel_init):
    net_kernel_params = {
            ...
            'deeper_net': {
                'down_conv_kernels': [
                    [(5, 50, 0, (0,0), kernel_init), (5, 50, dropout, (0,0), kernel_init)],
                    [(5, 100, 0, (0,0), kernel_init), (5, 100, dropout, (0,0), kernel_init)],
                    [(5, 100, 0, (0,0), kernel_init), (5, 100, dropout, reg, kernel_init)],
                    [(5, 200, 0 , (0,0), kernel_init), (5, 200, dropout, (0,0), kernel_init)],
                    [(5, 400, 0, (0,0), kernel_init), (5, 400, dropout, reg, kernel_init)],
                ],
                'lstm_kernels': [
                    [(5, 50, dropout, (0,0), kernel_init)],
                    [(5, 100, dropout, reg, kernel_init)],
                    [(5, 100, dropout, (0,0), kernel_init)],
                    [(5, 200, dropout, (0,0), kernel_init)],
                    [(5, 400, dropout, reg, kernel_init)],                
                ],
                'up_conv_kernels': [
                    [(5, 100, 0, (0,0), kernel_init), (5, 100, dropout, (0,0), kernel_init)],
                    [(5, 100, 0, (0,0), kernel_init), (5, 100, dropout, (0,0), kernel_init)],
                    [(5, 50, 0, (0,0), kernel_init), (5, 50, dropout, reg, kernel_init)],
                    [(5, 50, 0, (0,0), kernel_init), (5, 50, dropout, (0,0), kernel_init)],
                    [(5, 20, 0, (0,0), kernel_init), (5, 20, dropout, reg, kernel_init), (1, 1, dropout, reg, kernel_init)],
                ],
            },
            'original_net': {
                'down_conv_kernels': [
                    [(5, 100, 0, (0,0), kernel_init), (5, 100, dropout, (0,0), kernel_init)],
                    [(5, 200, 0, (0,0), kernel_init), (5, 200, dropout, reg, kernel_init)],
                    [(5, 200, 0, (0,0), kernel_init), (5, 200, dropout, (0,0), kernel_init)],
                    [(5, 400, 0, (0,0), kernel_init), (5, 400, dropout, reg, kernel_init)],
                ],
                'lstm_kernels': [
