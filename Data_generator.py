...
class DataGenerator(k.utils.Sequence):
    ...
    def __init__(self, list_IDs, filename, shuffle = False, image_crop_size=(128, 128), image_reshape_size=(128,128), unroll_len=7,batch_size=4,
    ...
    def __getitem__(self, index):
        ...
        real_ind = [self.list_IDs[k] for k in indexes]
        # Generate data
        all_images, all_seg = self.__data_generation(real_ind)
    ...
    def __data_generation(self, list_IDs_temp):
        ...
        # Initialization
        X = np.empty((self.batch_size, self.unroll_len, *self.dim, 1))
        y = np.empty((self.batch_size, self.unroll_len, *self.dim, 1))
